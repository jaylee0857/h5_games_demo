<template>
  <div class="home">
    ...
    <!-- 帳務 -->
    <div class="grid grid-cols-3 px-[2%] my-[5px]">
      <img
        class="justify-self-start"
        :src="getImageUrl('no6/images/home/1.png')"
        alt=""
      />
      <img
        class="justify-self-center"
        :src="getImageUrl('no6/images/home/2.png')"
        alt=""
      />
      <img
        class="justify-self-end"
        :src="getImageUrl('no6/images/home/3.png')"
        alt=""
      />
    </div>
    <!-- 會員顯示介面 -->
...
/** components */
import Banner from "@/widgets/pages/no6/banner";
import Marquee from "@/widgets/pages/no6/marquee";
import Game from "@/widgets/pages/no6/game";
...
@import "@/assets/scss/no6/home.scss";
